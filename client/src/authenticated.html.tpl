        ...
        <div class="layout-container">
            <div class="layout-content">
                <div class="layout-content-main">
                    ...
                    <form method="POST" action="{{ .LogoutUrl }}" class="mt-2 md:mt-4">
                        <button type="submit" class="p-0.5 text-sm font-medium rounded-lg group bg-linear-to-br red-to-yellow cursor-pointer">
                            <span class="relative text-xs md:text-sm w-full inline-flex items-center px-1.5 py-1 md:px-3 md:py-1.5 transition-all motion-reduce:transition-none ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-transparent group-hover:dark:bg-transparent">
                                Log out
                            </span>
                        </button>
                    </form>
