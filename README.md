...
| <a id="config-opt-authtailscalewhois_expectedtailnet"></a>YAML: `authTailscaleWhois_expectedTailnet`<br>Env: `TFA_AUTHTAILSCALEWHOIS_EXPECTEDTAILNET` | string | If non-empty, requires the Tailnet of the user to match this value<br>Ignored if `authMethod` is not `tailscalewhois`|  |
